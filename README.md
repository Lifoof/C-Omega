...
- **Nine organ‑specific models** (e.g., cardiovascular, respiratory, metabolic, renal, etc.)
- **Sex‑specific** modeling capturing hormonal (females) and functional decline (males) patterns
- **Prognostic utility** – AgeGap correlates with current disease burden, future incidence of 73 diseases, and all‑cause mortality
